...
var require_dist_cjs4 = __commonJS({
  "node_modules/.pnpm/@aws-sdk+credential-provider-node@3.972.29/node_modules/@aws-sdk/credential-provider-node/dist-cjs/index.js"(exports) {
    ...
    var remoteProvider = async (init) => {
      const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./dist-cjs-QOBE74S6.mjs");
...
`);
      ...
      async (awsIdentityProperties) => {
        ...
        const { fromIni } = await import("./dist-cjs-35LE7NZ6.mjs");
      ...
      async (awsIdentityProperties) => {
        ...
        const { fromTokenFile } = await import("./dist-cjs-LPHZYAOD.mjs");
