...
var init_voice = __esm({
  "src/commands/voice/voice.ts"() {
    ...
    call = async () => {
      ...
      const { isVoiceStreamAvailable } = await import("./voiceStreamSTT-TWAMBAJF.mjs");
      const { checkRecordingAvailability } = await import("./voice-WWVLAXWP.mjs");
      ...
      const { checkVoiceDependencies, requestMicrophonePermission } = await import("./voice-WWVLAXWP.mjs");
