...
function ResumeTask({
  ...
  if (loading) {
    return /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", padding: 1 }, /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "row" }, /* @__PURE__ */ react_default.createElement(Spinner, null), /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true }, "Loading Claude Code sessions\u2026")), /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, retrying ? "Retrying\u2026" : "Fetching your Claude Code sessions\u2026"));
  }
  if (loadErrorType) {
    return /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", padding: 1 }, /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true, color: "error" }, "Error loading Claude Code sessions"), renderErrorSpecificGuidance(loadErrorType), /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Press ", /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true }, "Ctrl+R"), " to retry \xB7 Press", " ", /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true }, escKey), " to cancel"));
  }
  if (sessions.length === 0) {
    return /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", padding: 1 }, /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true }, "No Claude Code sessions found", currentRepo && /* @__PURE__ */ react_default.createElement(ThemedText, null, " for ", currentRepo)), /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginTop: 1 }, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Press ", /* @__PURE__ */ react_default.createElement(ThemedText, { bold: true }, escKey), " to cancel")));
  }
...
function renderErrorSpecificGuidance(errorType) {
  switch (errorType) {
    ...
    case "other":
      return /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginY: 1, flexDirection: "row" }, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Sorry, Claude Code encountered an error"));
  }
}
