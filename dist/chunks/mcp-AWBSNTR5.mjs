...
import {
  ...
  init_PluginSettings
} from "./chunk-VS4NK5LC.mjs";
import "./chunk-2D4SVODM.mjs";
import {
...
function MCPListPanel(t0) {
  ...
  if ($[60] !== hasFailedClients) {
    t26 = hasFailedClients && /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, debugMode ? "\u203B Error logs shown inline with --debug" : "\u203B Run claude --debug to see error logs");
    $[60] = hasFailedClients;
    $[61] = t26;
  } else {
    t26 = $[61];
