...
import {
  getGhAuthStatus,
  init_ghAuthStatus
} from "./chunk-FVY4KH7Q.mjs";
import {
  LoadingState,
  init_LoadingState
} from "./chunk-IGA5DXOK.mjs";
import {
  Select,
  fetchEnvironments,
  init_CustomSelect,
...
function Web({
    ...
    void checkLoginState().then(async (result) => {
      switch (result.status) {
        case "not_signed_in":
          ...
          onDone("Not signed in to Blaude. Run /login first.");
          return;
  ...
  if (step.name === "uploading") {
    return /* @__PURE__ */ createElement(LoadingState, { message: "Connecting GitHub to Blaude\u2026" });
  }
  const token = step.token;
  return /* @__PURE__ */ createElement(Dialog, { title: "Connect Blaude on the web to GitHub?", onCancel: handleCancel, hideInputGuide: true }, /* @__PURE__ */ createElement(ThemedBox_default, { flexDirection: "column" }, /* @__PURE__ */ createElement(ThemedText, null, "Blaude on the web requires connecting to your GitHub account to clone and push code on your behalf."), /* @__PURE__ */ createElement(ThemedText, { dimColor: true }, "Your local credentials are used to authenticate with GitHub")), /* @__PURE__ */ createElement(Select, { options: [{
    label: "Continue",
    value: "send"
  }, {
    label: "Cancel",
