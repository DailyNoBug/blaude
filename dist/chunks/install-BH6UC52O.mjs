...
function Install({
  ...
  return /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", marginTop: 1 }, state.type === "checking" && /* @__PURE__ */ react_default.createElement(ThemedText, { color: "claude" }, "Checking installation status..."), state.type === "cleaning-npm" && /* @__PURE__ */ react_default.createElement(ThemedText, { color: "warning" }, "Cleaning up old npm installations..."), state.type === "installing" && /* @__PURE__ */ react_default.createElement(ThemedText, { color: "claude" }, "Installing Claude Code native build ", state.version, "..."), state.type === "setting-up" && /* @__PURE__ */ react_default.createElement(ThemedText, { color: "claude" }, "Setting up launcher and shell integration..."), state.type === "set-up" && /* @__PURE__ */ react_default.createElement(SetupNotes, { messages: state.messages }), state.type === "success" && /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", gap: 1 }, /* @__PURE__ */ react_default.createElement(ThemedBox_default, null, /* @__PURE__ */ react_default.createElement(StatusIcon, { status: "success", withSpace: true }), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "success", bold: true }, "Claude Code successfully installed!")), /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginLeft: 2, flexDirection: "column", gap: 1 }, state.version !== "current" && /* @__PURE__ */ react_default.createElement(ThemedBox_default, null, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Version: "), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "claude" }, state.version)), /* @__PURE__ */ react_default.createElement(ThemedBox_default, null, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Location: "), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "text" }, getInstallationPath()))), /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginLeft: 2, flexDirection: "column", gap: 1 }, /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginTop: 1 }, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Next: Run "), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "claude", bold: true }, "claude --help"), /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, " to get started"))), state.setupMessages && /* @__PURE__ */ react_default.createElement(SetupNotes, { messages: state.setupMessages })), state.type === "error" && /* @__PURE__ */ react_default.createElement(ThemedBox_default, { flexDirection: "column", gap: 1 }, /* @__PURE__ */ react_default.createElement(ThemedBox_default, null, /* @__PURE__ */ react_default.createElement(StatusIcon, { status: "error", withSpace: true }), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "error" }, "Installation failed")), /* @__PURE__ */ react_default.createElement(ThemedText, { color: "error" }, state.message), /* @__PURE__ */ react_default.createElement(ThemedBox_default, { marginTop: 1 }, /* @__PURE__ */ react_default.createElement(ThemedText, { dimColor: true }, "Try running with --force to override checks"))));
}
var install = {
  type: "local-jsx",
  name: "install",
