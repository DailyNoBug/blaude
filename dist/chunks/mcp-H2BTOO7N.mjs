...
`);
  ...
  if ($[28] !== handleEscCancel || $[29] !== t10 || $[30] !== t11 || $[31] !== t15) {
    t16 = /* @__PURE__ */ react_default.createElement(Dialog, { title: "Import MCP Servers from Claude Desktop", subtitle: t10, color: "success", onCancel: handleEscCancel, hideInputGuide: true }, t11, t12, t15);
    $[28] = handleEscCancel;
    $[29] = t10;
    $[30] = t11;
    $[31] = t15;
...
async function mcpServeHandler({
  ...
  try {
    const {
      setup
    } = await import("./setup-7HF3XWZS.mjs");
    await setup(providedCwd, "default", false, false, void 0, false);
    const {
      startMCPServer
    } = await import("./mcp-7LZEEAU3.mjs");
...
async function mcpAddFromDesktopHandler(options) {
  try {
    ...
    } = await import("./claudeDesktop-7ZS2PL5J.mjs");
