...
function SessionInfo(t0) {
  ...
  if (!remoteSessionUrl) {
    ...
    if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t42 = /* @__PURE__ */ createElement(Pane, null, /* @__PURE__ */ createElement(ThemedText, { color: "warning" }, "Not in remote mode. Start with `claude --remote` to use this command."), /* @__PURE__ */ createElement(ThemedText, { dimColor: true }, "(press esc to close)"));
      $[4] = t42;
    } else {
      t42 = $[4];
    }
