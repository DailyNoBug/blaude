...
function TrustDialog(t0) {
  ...
  if ($[20] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    ...
    t18 = /* @__PURE__ */ react_default.createElement(ThemedText, null, "Claude Code", "'", "ll be able to read, edit, and execute files here.");
    $[20] = t16;
    $[21] = t17;
    $[22] = t18;
  } else {
