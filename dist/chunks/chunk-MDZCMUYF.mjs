...
function ThinkbackMenu(t0) {
  ...
  let t4;
  if ($[8] !== hasGenerated) {
    t4 = !hasGenerated && /* @__PURE__ */ createElement(ThemedBox_default, { flexDirection: "column" }, /* @__PURE__ */ createElement(ThemedText, null, "Relive your year of coding with Claude."), /* @__PURE__ */ createElement(ThemedText, { dimColor: true }, "We'll create a personalized ASCII animation celebrating your journey."));
    $[8] = hasGenerated;
    $[9] = t4;
  } else {
    t4 = $[9];
  ...
  if ($[16] !== handleCancel || $[17] !== t6) {
    t7 = /* @__PURE__ */ createElement(Dialog, { title: "Think Back on 2025 with Claude Code", subtitle: "Generate your 2025 Claude Code Think Back (takes a few minutes to run)", onCancel: handleCancel, color: "claude" }, t6);
    $[16] = handleCancel;
    $[17] = t6;
    $[18] = t7;
  } else {
