...
function PermissionDescription() {
  ...
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ createElement(ThemedText, { dimColor: true }, "Claude Code will be able to read files in this directory and make edits when auto-accept edits is on.");
    $[0] = t0;
  } else {
    t0 = $[0];
  }
