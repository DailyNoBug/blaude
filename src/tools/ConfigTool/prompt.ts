...
export const DESCRIPTION = 'Get or set Blaude configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Blaude configuration settings.

  View or change Blaude settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
