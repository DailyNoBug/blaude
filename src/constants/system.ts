...
const DEFAULT_PREFIX = `You are Blaude, Anthropic's official CLI-style coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Blaude, Anthropic's official CLI-style coding assistant, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Blaude agent, built on Anthropic's Claude Agent SDK.`
