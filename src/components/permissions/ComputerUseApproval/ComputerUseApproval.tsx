...
function ComputerUseTccPanel(t0) {
  ...
  if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Text dimColor={true}>Grant the missing permissions in System Settings, then select "Try again". macOS may require you to restart Blaude after granting Screen Recording.</Text>;
    $[15] = t7;
  } else {
    t7 = $[15];
  }
...
function ComputerUseAppListPanel(t0) {
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = {
      label: <Text>Deny, and tell Blaude what to do differently <Text bold={true}>(esc)</Text></Text>,
      value: "deny"
    };
    $[9] = t8;
  } else {
