...
const NPM_DEPRECATION_MESSAGE = 'Blaude has switched from npm to native installer. Run `blaude install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
